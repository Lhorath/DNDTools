<!--
    ...
    =================================
    This file creates the Dice Roller tool. The layout has been updated to a
    two-column design with the main tool on the left and a sidebar on the right.
-->
...
<div class="flex flex-col lg:flex-row gap-8">
    ...
    <!-- 
        ...
        primary content for the dice roller tool.
    -->
    <div class="lg:w-3/4">
                ...
                <div class="lg:col-span-1 space-y-6">
                    ...
                    <div class="panel p-6 center">
                        ...
                        <div class="grid grid-cols-3 gap-4 text-center content-center">
                            <div class="flex justify-center"><img src="<?php echo BASE_URL; ?>style/images/dice/d4.png" alt="D4" class="dice-btn" data-sides="4"></div>
                            <div class="flex justify-center"><img src="<?php echo BASE_URL; ?>style/images/dice/d6.png" alt="D6" class="dice-btn" data-sides="6"></div>
                            <div class="flex justify-center"><img src="<?php echo BASE_URL; ?>style/images/dice/d8.png" alt="D8" class="dice-btn" data-sides="8"></div>
                            <div class="flex justify-center"><img src="<?php echo BASE_URL; ?>style/images/dice/d10.png" alt="D10" class="dice-btn" data-sides="10"></div>
                            <div class="flex justify-center"><img src="<?php echo BASE_URL; ?>style/images/dice/d12.png" alt="D12" class="dice-btn" data-sides="12"></div>
                            <div class="flex justify-center"><img src="<?php echo BASE_URL; ?>style/images/dice/d20.png" alt="D20" class="dice-btn" data-sides="20"></div>
                        </div>
                    </div>
                    ...
                    <!-- Main Roll Button -->
                    <button id="rollButton" class="w-full action-button font-bold text-2xl py-4 rounded-lg transition-all title-font">
                        Roll!
                    </button>
                </div>
                ...
                <div class="lg:col-span-2 space-y-6">
                    ...
                    <div class="panel p-6 flex flex-col h-[400px] md:h-auto lg:max-h-[calc(100vh-300px)]">
                        ...
                        <div id="historyLog" class="flex-grow overflow-y-auto space-y-3 pr-2">
                            <!-- History items are dynamically inserted here by JavaScript -->
                        </div>
                    </div>
                </div>
            </div>
