<div id="character-sheet" class="max-w-7xl mx-auto p-4 md:p-6 rounded-xl shadow-2xl" style="background-color: rgba(29, 29, 29, 0.9); backdrop-filter: blur(2px);">
    ...
    <div class="section mb-6">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
            ...
            <div id="subclass-wrapper"><label for="subclass">Subclass</label><select id="subclass" name="subclass"></select></div>
            ...
            <div id="subrace-wrapper" class="hidden"><label for="subrace">Subrace</label><select id="subrace" name="subrace"></select></div>
            <div><label for="background">Background</label><select id="background" name="background"></select></div>
            <div><label for="alignment">Alignment</label><select id="alignment" name="alignment"></select></div>
        ...
        <div class="lg:col-span-1 flex flex-col gap-6">
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 gap-6">
                ...
                <div class="section">
                    ...
                    <hr class="my-4 border-gray-600">
                    <div class="space-y-2">
                        <div class="flex items-center"><input type="checkbox" id="strength-save-prof" data-ability="strength" class="prof-check me-2"><label for="strength-save-prof" class="flex-grow text-lg">Strength</label><input type="text" id="strength-save" class="stat-view" readonly></div>
                        <div class="flex items-center"><input type="checkbox" id="dexterity-save-prof" data-ability="dexterity" class="prof-check me-2"><label for="dexterity-save-prof" class="flex-grow text-lg">Dexterity</label><input type="text" id="dexterity-save" class="stat-view" readonly></div>
                        <div class="flex items-center"><input type="checkbox" id="constitution-save-prof" data-ability="constitution" class="prof-check me-2"><label for="constitution-save-prof" class="flex-grow text-lg">Constitution</label><input type="text" id="constitution-save" class="stat-view" readonly></div>
                        <div class="flex items-center"><input type="checkbox" id="intelligence-save-prof" data-ability="intelligence" class="prof-check me-2"><label for="intelligence-save-prof" class="flex-grow text-lg">Intelligence</label><input type="text" id="intelligence-save" class="stat-view" readonly></div>
                        <div class="flex items-center"><input type="checkbox" id="wisdom-save-prof" data-ability="wisdom" class="prof-check me-2"><label for="wisdom-save-prof" class="flex-grow text-lg">Wisdom</label><input type="text" id="wisdom-save" class="stat-view" readonly></div>
                        <div class="flex items-center"><input type="checkbox" id="charisma-save-prof" data-ability="charisma" class="prof-check me-2"><label for="charisma-save-prof" class="flex-grow text-lg">Charisma</label><input type="text" id="charisma-save" class="stat-view" readonly></div>
                    </div>
                </div>
            </div>
            ...
            <div class="section">
                ...
                <hr class="my-4 border-gray-600">
                <div class="space-y-2">
                    <div class="flex items-center"><input type="checkbox" id="acrobatics-prof" data-ability="dexterity" class="prof-check me-2"><label for="acrobatics-prof" class="flex-grow">Acrobatics <span class="text-xs text-muted">(Dex)</span></label><input type="text" id="acrobatics" class="stat-view" readonly></div>
                    <div class="flex items-center"><input type="checkbox" id="animal-handling-prof" data-ability="wisdom" class="prof-check me-2"><label for="animal-handling-prof" class="flex-grow">Animal Handling <span class="text-xs text-muted">(Wis)</span></label><input type="text" id="animal-handling" class="stat-view" readonly></div>
                    <div class="flex items-center"><input type="checkbox" id="arcana-prof" data-ability="intelligence" class="prof-check me-2"><label for="arcana-prof" class="flex-grow">Arcana <span class="text-xs text-muted">(Int)</span></label><input type="text" id="arcana" class="stat-view" readonly></div>
                    <div class="flex items-center"><input type="checkbox" id="athletics-prof" data-ability="strength" class="prof-check me-2"><label for="athletics-prof" class="flex-grow">Athletics <span class="text-xs text-muted">(Str)</span></label><input type="text" id="athletics" class="stat-view" readonly></div>
                    <div class="flex items-center"><input type="checkbox" id="deception-prof" data-ability="charisma" class="prof-check me-2"><label for="deception-prof" class="flex-grow">Deception <span class="text-xs text-muted">(Cha)</span></label><input type="text" id="deception" class="stat-view" readonly></div>
                    <div class="flex items-center"><input type="checkbox" id="history-prof" data-ability="intelligence" class="prof-check me-2"><label for="history-prof" class="flex-grow">History <span class="text-xs text-muted">(Int)</span></label><input type="text" id="history" class="stat-view" readonly></div>
                    <div class="flex items-center"><input type="checkbox" id="insight-prof" data-ability="wisdom" class="prof-check me-2"><label for="insight-prof" class="flex-grow">Insight <span class="text-xs text-muted">(Wis)</span></label><input type="text" id="insight" class="stat-view" readonly></div>
                    <div class="flex items-center"><input type="checkbox" id="intimidation-prof" data-ability="charisma" class="prof-check me-2"><label for="intimidation-prof" class="flex-grow">Intimidation <span class="text-xs text-muted">(Cha)</span></label><input type="text" id="intimidation" class="stat-view" readonly></div>
                    <div class="flex items-center"><input type="checkbox" id="investigation-prof" data-ability="intelligence" class="prof-check me-2"><label for="investigation-prof" class="flex-grow">Investigation <span class="text-xs text-muted">(Int)</span></label><input type="text" id="investigation" class="stat-view" readonly></div>
                    <div class="flex items-center"><input type="checkbox" id="medicine-prof" data-ability="wisdom" class="prof-check me-2"><label for="medicine-prof" class="flex-grow">Medicine <span class="text-xs text-muted">(Wis)</span></label><input type="text" id="medicine" class="stat-view" readonly></div>
                    <div class="flex items-center"><input type="checkbox" id="nature-prof" data-ability="intelligence" class="prof-check me-2"><label for="nature-prof" class="flex-grow">Nature <span class="text-xs text-muted">(Int)</span></label><input type="text" id="nature" class="stat-view" readonly></div>
                    <div class="flex items-center"><input type="checkbox" id="perception-prof" data-ability="wisdom" class="prof-check me-2"><label for="perception-prof" class="flex-grow">Perception <span class="text-xs text-muted">(Wis)</span></label><input type="text" id="perception" class="stat-view" readonly></div>
                    <div class="flex items-center"><input type="checkbox" id="performance-prof" data-ability="charisma" class="prof-check me-2"><label for="performance-prof" class="flex-grow">Performance <span class="text-xs text-muted">(Cha)</span></label><input type="text" id="performance" class="stat-view" readonly></div>
                    <div class="flex items-center"><input type="checkbox" id="persuasion-prof" data-ability="charisma" class="prof-check me-2"><label for="persuasion-prof" class="flex-grow">Persuasion <span class="text-xs text-muted">(Cha)</span></label><input type="text" id="persuasion" class="stat-view" readonly></div>
                    <div class="flex items-center"><input type="checkbox" id="religion-prof" data-ability="intelligence" class="prof-check me-2"><label for="religion-prof" class="flex-grow">Religion <span class="text-xs text-muted">(Int)</span></label><input type="text" id="religion" class="stat-view" readonly></div>
                    <div class="flex items-center"><input type="checkbox" id="sleight-of-hand-prof" data-ability="dexterity" class="prof-check me-2"><label for="sleight-of-hand-prof" class="flex-grow">Sleight of Hand <span class="text-xs text-muted">(Dex)</span></label><input type="text" id="sleight-of-hand" class="stat-view" readonly></div>
                    <div class="flex items-center"><input type="checkbox" id="stealth-prof" data-ability="dexterity" class="prof-check me-2"><label for="stealth-prof" class="flex-grow">Stealth <span class="text-xs text-muted">(Dex)</span></label><input type="text" id="stealth" class="stat-view" readonly></div>
                    <div class="flex items-center"><input type="checkbox" id="survival-prof" data-ability="wisdom" class="prof-check me-2"><label for="survival-prof" class="flex-grow">Survival <span class="text-xs text-muted">(Wis)</span></label><input type="text" id="survival" class="stat-view" readonly></div>
                </div>
            </div>
        </div>
