<!--
    ...
    =====================================
    This file provides the user registration form. Its layout has been updated
    to a two-column design with the main content on the left and a sidebar
    on the right.
-->
...
<div class="flex flex-col lg:flex-row gap-8">
    ...
    <!-- 
        ...
        primary content for the "Register" page.
    -->
    <div class="lg:w-3/4">
        <!-- Main container for the registration page content -->
        <div id="registration-page" class="max-w-xl mx-auto p-4 md:p-10 rounded-xl shadow-2xl" style="background-color: rgba(29, 29, 29, 0.9); backdrop-filter: blur(2px);">
            ...
            <!-- 
                ...
                sends the data to the registration API endpoint.
            -->
            ...
            <p class="text-center mt-6 text-muted">
                Already have an account? <a href="<?php echo BASE_URL; ?>login" class="text-accent-red hover:underline font-bold">Log In</a>
            </p>
        </div>
    </div>
