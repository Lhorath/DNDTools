        ...
        <div id="tools" class="max-w-7xl mx-auto p-4 md:p-10 rounded-xl shadow-2xl" style="background-color: rgba(29, 29, 29, 0.9); backdrop-filter: blur(2px);">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div class="tool-card overflow-hidden flex flex-col">
                    <img class="w-full h-48 object-cover" src="<?php echo BASE_URL; ?>style/images/sheet.jpg" alt="Character Sheet" />
                ...
                <div class="tool-card overflow-hidden flex flex-col">
                    <img class="w-full h-48 object-cover" src="<?php echo BASE_URL; ?>style/images/dice.jpg" alt="Dice Roller" />
                    <div class="p-5 flex flex-col flex-grow">
                ...
                <div class="tool-card overflow-hidden flex flex-col">
                    <img class="w-full h-48 object-cover" src="<?php echo BASE_URL; ?>style/images/compendium.jpg" alt="Compendium" />
                    <div class="p-5 flex flex-col flex-grow">
                ...
                <div class="tool-card overflow-hidden flex flex-col">
                    <img class="w-full h-48 object-cover" src="<?php echo BASE_URL; ?>style/images/initiative.jpg" alt="Initiative Tracker" />
                    <div class="p-5 flex flex-col flex-grow">
