<?php
/*
    Dack's DND Tools - /includes/meta/login.php
    ===========================================
    This file contains all the specific metadata for the "Login" page.
    It is included by core/header.php when the login page is loaded.
*/

// --- SECTION 1: SEO & PAGE INFORMATION ---
// =========================================
// This data is used to populate the primary meta tags for search engines.
$title = "Login | Dack's DND Tools";
$description = "Log in to your Dack's DND Tools account to access your saved characters and other personalized features.";
$keywords = "D&D tools login, Dungeons and Dragons account, user login, sign in";
...
$og_title = "Login to Dack's DND Tools";
$og_description = "Access your free D&D 5e toolkit. Log in to manage your characters and more.";
$og_type = "website";
$og_url = BASE_URL . "login";
