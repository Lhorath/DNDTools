<?php
/*
    Dack's DND Tools - /includes/meta/sheet.php
    ===========================================
    This file contains all the specific metadata for the "Character Sheet" page.
    It is included by core/header.php when the sheet page is loaded.
*/

// --- SECTION 1: SEO & PAGE INFORMATION ---
// =========================================
// This data is used to populate the primary meta tags for search engines.
$title = "Character Sheet | Dack's DND Tools";
$description = "A fully editable digital D&D 5e character sheet that auto-loads class and race data, calculates modifiers, and can be downloaded as a PDF.";
$keywords = "D&D character sheet, 5e character sheet, digital character sheet, Dungeons and Dragons sheet, character creator, fillable pdf";
...
$og_title = "D&D 5e Character Sheet | Dack's DND Tools";
$og_description = "Create and manage your D&D 5th Edition characters with a powerful, data-driven digital sheet.";
$og_type = "website";
$og_url = BASE_URL . "sheet";
