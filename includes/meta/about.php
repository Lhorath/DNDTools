<?php
/*
    Dack's DND Tools - /includes/meta/about.php
    ===========================================
    This file contains all the specific metadata for the "About Us" page.
    It is included by core/header.php when the about page is loaded.
*/

// --- SECTION 1: SEO & PAGE INFORMATION ---
// =========================================
// This data is used to populate the primary meta tags for search engines.
$title = "About | Dack's DND Tools";
$description = "Learn about the philosophy behind Dack's DND Tools, a free, simple, and elegant suite of web-based tools designed to enhance the Dungeons & Dragons 5e experience.";
$keywords = "About D&D Tools, Dungeons and Dragons, 5e, TTRPG, creator, Dackary McDab, free d&d tools, web-based";
...
$og_title = "About Dack's DND Tools";
$og_description = "Discover the story and philosophy behind our free, elegant toolkit for Dungeons & Dragons 5th Edition.";
$og_type = "website";
$og_url = BASE_URL . "about";
$og_image = BASE_URL . "style/images/og-image.jpg"; // A 1200x630px image is recommended
